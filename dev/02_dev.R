...
# usethis::use_dev_package(package = "ecopiapi", type = "Imports", remote = "OekoFor/ecopiapi@v0.2.3")
## Add modules ----
...
usethis::use_github(organisation = "BirdNETPLus")
